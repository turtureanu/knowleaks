...
Section 3.2 of the [UEFI Shell Spec 2.0](https://uefi.org/sites/default/files/resources/UEFI_Shell_Spec_2_0.pdf) describes an option (`--nostartup`) that can be passed to the UEFI shell to prevent the loading of the script. I am, however, unsure how someone might actually pass it.
