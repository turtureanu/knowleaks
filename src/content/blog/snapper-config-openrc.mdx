---
title: "Configuring snapper with any init system that isn't systemd"
description: "How to set up snapper with any init system other than systemd. This is done using cron."
pubDate: 2023-03-24
tags: [linux, security]
---
...
Because of how `snapper` works, on any system that doesn't use `systemd`, you'll need to install `cronie` or a similar cron implementation that provides you with `cron` directories, such as `/etc/cron.hourly` or `/etc/cron.daily`.
