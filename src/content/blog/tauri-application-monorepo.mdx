...
This creates a `.moon/` directory at the root of the project. Inside it there is a `workspace.yml` file.
...
Tasks define the tasks that can be run, for brevity, here are the tasks I want configured:
